...
def main():
    ...
    # args.initmodel = './datas/result/17_12_06/model_iter_1500000'
    if args.initmodel:
    ...
    serializers.save_hdf5(args.out + '/model.model', model)
    serializers.save_hdf5(args.out + '/model.state', optimizer)
